...
| 13 | Worker `InProgress()` / größeres `AckWait`; Delivery-Count → DLQ statt `MaxDeliver: -1` | High | Medium | Redelivery-Races, Poison-Message-Loops |
...
1. **#13** AckWait / MaxDeliver — Korrektheit unter Last  
2. **#12** Metriken — Operability  
3. **#15** Quota-Buckets — Scale-Fail-Closed vermeiden  
